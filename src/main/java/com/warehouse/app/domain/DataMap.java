...
public class DataMap<V> extends HashMap<String,V> implements Map<String,V>, Cloneable, Serializable {

    private DataMap<Object> getStructure(String key, boolean exception) {
        V value = get(key);
    ...
    private DataMap<Object> parseMap(String key) {
        V value = get(key);
        DataMap<Object> parsedValue = new DataMap<>();
        ...
        if(value instanceof Map) {
            ...
            return (DataMap<Object>) get(key);
        }

        return null;
    }

    public DataMap getStructureHard(String key) {
        return getStructure(key, true);
    }

    public DataMap getStructureSoft(String key) {
