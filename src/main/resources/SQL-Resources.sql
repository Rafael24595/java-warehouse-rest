...
INSERT INTO db_roles (id, name) VALUES (1, 'USER');
INSERT INTO db_users (id, nickname, password, date_origen, date_modify, level)  VALUES (1, 'Test', '****', TO_DATE('20221121','YYYYMMDD'), TO_DATE('20221121','YYYYMMDD'), 100);
